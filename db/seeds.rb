...
#Example hosts-------------------------------------------------------------------------------------------
host1 = User.create(first_name: "Deanna", last_name: "Melin", email: "deanna@email.com", password:
"1234asdf", avatar: "http://i.imgur.com/PnDd7Ly.jpg", about_me: "Bavarian bergkase cheese and wine fromage
...
host2 = User.create(first_name: "Juan", last_name: "Perez", email: "juan@email.com", password:
"1234asdf", avatar: "http://i.imgur.com/QulNWO9.jpg", about_me: "Rubber cheese parmesan st. agur blue cheese.
...
host3 = User.create(first_name: "David", last_name: "Karim", email: "david@email.com", password:
"1234asdf", avatar: "http://i.imgur.com/5ke9L8e.jpg", about_me: "Cheesy feet pecorino lancashire. Brie
...
host4 = User.create(first_name: "Brian", last_name: "Knickerson", email: "brian@email.com", password:
"1234asdf", avatar: "http://i.imgur.com/FVEHhNA.jpg", about_me: "Boursin port-salut port-salut. Parmesan
...
password: "1234asdf", avatar: "http://i.imgur.com/UFPjqJY.jpg", about_me: "Babybel pepper jack
...
password: "1234asdf", avatar: "http://i.imgur.com/So130Rv.jpg", about_me: "Danish fontina port-salut
...
password: "1234asdf", avatar: "http://i.imgur.com/CDu6M6K.jpg", about_me: "Gouda hard cheese everyone
...
host8 = User.create(first_name: "Don", last_name: "Morehouse", email: "don@email.com", password: "1234asdf",
...
host9 = User.create(first_name: "Greg", last_name: "Hedrick", email: "greg@email.com", password:
"1234asdf", avatar: "http://i.imgur.com/HxibdsR.jpg", about_me: "Stinking bishop lancashire cottage cheese.
...
password: "1234asdf", avatar: "http://i.imgur.com/16jh4ew.jpg", about_me: "Roquefort feta cheeseburger.
...
x = 1
9.times do
  Address.create(street_address:"address#{x}", city:"address#{x}", country:"address#{x}", listing_id:x)
  x +=1
end
