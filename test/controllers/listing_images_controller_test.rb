...
class ListingImagesControllerTest < ActionController::TestCase
  ...
  test "should create listing_image" do
    assert_difference('ListingImage.count') do
      post :create, listing_image: { caption: @listing_image.caption, listing_id: @listing_image.listing_id, picture: @listing_image.picture }
    end
  ...
  test "should update listing_image" do
    patch :update, id: @listing_image, listing_image: { caption: @listing_image.caption, listing_id: @listing_image.listing_id, picture: @listing_image.picture }
    assert_redirected_to listing_image_path(assigns(:listing_image))
  end
